...
// Exported init function, can be used elsewhere to confirm the Quran widget is loaded
export function initQuran() {
    console.log("Quran ready");  // Console message to indicate Quran module is initialized
}
